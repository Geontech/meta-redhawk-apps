# This file sets OSSIEHOME and other environment variables used by autotools for C++ REDHAWK libraries which aren't shared packages
inherit redhawk-cpp-lib-oeconf redhawk-sysroot pythonnative
